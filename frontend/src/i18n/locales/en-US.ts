export default {
  ...
  agent: {
    ...
    editor: {
      ...
      nameDesc: 'Set an easily identifiable name for the agent',
      descriptionDesc: 'Briefly describe the purpose and characteristics of the agent',
      systemPromptDesc: 'Custom system prompt to define agent behavior and role',
      systemPromptDescBuiltin: 'Custom system prompt to define agent behavior and role (leave empty to use system default)',
      availableVariables: 'Available Variables:',
      clickToInsert: '(Click to insert)',
      clickToInsertOrType: '(Click to insert, or type {{ to trigger list)',
      contextTemplateDesc: 'Define how retrieved content is formatted and passed to the model',
      contextTemplateDescBuiltin: 'Define how retrieved content is formatted and passed to the model (leave empty to use system default)',
      ...
      maxCompletionTokensDesc: 'Maximum number of tokens the model can generate in response',
      conversationSettingsDesc: 'Configure multi-turn conversation and query rewrite parameters',
      multiTurnDesc: 'Enable to retain historical conversation context',
      historyTurnsDesc: 'Retain the most recent conversation turns as context',
      enableRewriteDesc: 'Automatically rewrite user queries in multi-turn conversations to resolve references and complete ellipsis',
      rewriteSystemPromptDesc: 'System prompt for query rewriting (leave empty to use default)',
      rewriteUserPromptDesc: 'User prompt template for query rewriting (leave empty to use default)',
      ...
      mcpServiceDesc: 'Select MCP services that the Agent can call',
      allMcp: 'All',
      selectedMcp: 'Selected',
      noneMcp: 'Disabled',
      selectMcpService: 'Select MCP Service',
      selectMcpServiceDesc: 'Select MCP services to enable',
      selectMcpServicePlaceholder: 'Select MCP Service',
      knowledgeBasesDesc: 'Select the range of knowledge bases accessible to the agent',
      ...
      faqPriorityStrategyDesc: 'When knowledge bases contain FAQs (question-answer pairs), you can enable this strategy to prioritize FAQ answers over regular documents',
      enableFaqPriority: 'Enable FAQ Priority',
      enableFaqPriorityDesc: 'FAQ answers will be prioritized over regular documents for citation, improving answer accuracy',
      directAnswerThreshold: 'Direct Answer Threshold',
      directAnswerThresholdDesc: 'When question similarity to FAQ exceeds this value, directly use FAQ answer',
      faqScoreBoost: 'FAQ Score Boost',
      faqScoreBoostDesc: 'Multiply FAQ result relevance score by this coefficient to rank them higher',
      webSearchDesc: 'After enabling, the agent can search the internet to obtain information',
      ...
      enableQueryExpansionDesc: 'Automatically expand query terms to improve recall rate',
      ...
      rerankTopKDesc: 'Maximum number of results retained after reranking',
      rerankThresholdDesc: 'Minimum relevance score for reranking',
      fallbackStrategyDesc: 'How to handle when no relevant content is found in the knowledge base',
      ...
      fallbackPromptDesc: 'Prompt to guide model generation when no answer is found in the knowledge base',
      toolDisabledHint: '(Knowledge base configuration required)',
    },
    selector: {
      title: 'Select Agent',
