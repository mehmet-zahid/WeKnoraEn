...
const handleEnabledChange = () => {
  // When disabling extraction, clear all data
...
const defaultExtractExample = () => {
  localGraphExtract.value.text = `The Great Gatsby is a 1925 novel by American writer F. Scott Fitzgerald. Set in the Jazz Age on prosperous Long Island, it follows Nick Carraway's interactions with mysterious millionaire Jay Gatsby and Gatsby's obsession with reuniting with his former lover, Daisy Buchanan. The novel explores themes of decadence, idealism, resistance to change, social upheaval, and excess, creating a portrait of the Jazz Age that has been described as a cautionary tale regarding the American Dream.`
  localGraphExtract.value.tags = ['Author', 'Genre']
  localGraphExtract.value.nodes = [
    {name: 'The Great Gatsby', attributes: ['1925 novel', 'American literature classic', 'Jazz Age novel']},
    {name: 'F. Scott Fitzgerald', attributes: ['American writer', 'Author of The Great Gatsby']},
    {name: 'Jay Gatsby', attributes: ['Main character', 'Mysterious millionaire']},
    {name: 'Daisy Buchanan', attributes: ['Character', 'Gatsby\'s former lover']}
  ]
  localGraphExtract.value.relations = [
    {node1: 'The Great Gatsby', node2: 'F. Scott Fitzgerald', type: 'Author'},
    {node1: 'The Great Gatsby', node2: 'Jay Gatsby', type: 'Main Character'},
    {node1: 'The Great Gatsby', node2: 'Daisy Buchanan', type: 'Character'}
  ]
  handleNodesChange()
...
const loadModelStatus = async () => {
  try {
    ...
    // Find available KnowledgeQA models (conversation models)
