<template>
    <div class="bot_msg">
        ...
        <div ref="parentMd" v-if="!session.hideContent && !session.isAgentMode">
            <!-- Render loading animation when message is being summarized -->
            ...
            <!-- Directly render complete content to avoid issues from splitting, style consistent with thinking -->
