...
// FAQChunkMetadata defines the structure of FAQ entry in Chunk.Metadata
...
// DocumentChunkMetadata defines the metadata structure for document Chunk
// Used to store AI-generated questions and other enhanced information
