...
func GetBuiltinQuickAnswerAgent(tenantID uint64) *CustomAgent {
	return &CustomAgent{
		...
		Name:        "Quick Answer",
		Description: "RAG-based Q&A using knowledge base, quickly and accurately answering questions",
		IsBuiltin:   true,
		TenantID:    tenantID,
...
func GetBuiltinDataAnalystAgent(tenantID uint64) *CustomAgent {
	return &CustomAgent{
		...
		Name:        "Data Analyst",
		Description: "Professional data analysis agent, supporting SQL queries and statistical analysis of CSV/Excel files",
		Avatar:      "📊",
		IsBuiltin:   true,
		TenantID:    tenantID,
		Config: CustomAgentConfig{
