...
// @Accept       json
// @Produce      json
// @Param        request  body      types.Tenant  true  "Tenant information"
// @Success      201      {object}  map[string]interface{}  "Created tenant"
...
// @Failure      400  {object}  errors.AppError         "Invalid request parameters"
// @Failure      404  {object}  errors.AppError         "Tenant not found"
// @Security     Bearer
// @Security     ApiKeyAuth
...
// @Param        id       path      int           true  "Tenant ID"
// @Param        request  body      types.Tenant  true  "Tenant information"
// @Success      200      {object}  map[string]interface{}  "Updated tenant"
// @Failure      400      {object}  errors.AppError         "Invalid request parameters"
// @Security     Bearer
...
// @Description  Delete specified tenant
// @Tags         Tenant Management
// @Accept       json
// @Produce      json
// @Param        id   path      int  true  "Tenant ID"
...
// @Accept       json
// @Produce      json
// @Success      200  {object}  map[string]interface{}  "Tenant list"
...
// @Accept       json
// @Produce      json
// @Success      200  {object}  map[string]interface{}  "All tenants list"
...
// @Description  Paginated search for tenants (requires cross-tenant access permission)
// @Tags         Tenant Management
// @Accept       json
// @Produce      json
// @Param        keyword    query     string  false  "Search keyword"
// @Param        tenant_id  query     int     false  "Tenant ID filter"
...
// @Accept       json
// @Produce      json
// @Success      200  {object}  map[string]interface{}  "Agent configuration"
// @Failure      400  {object}  errors.AppError         "Invalid request parameters"
// @Security     Bearer
// @Security     ApiKeyAuth
...
func (h *TenantHandler) GetTenantAgentConfig(c *gin.Context) {
	...
	// Get available tools list from tools package
	...
	// Get placeholder definitions from agent package
...
// @Accept       json
// @Produce      json
// @Success      200  {object}  map[string]interface{}  "Conversation configuration"
// @Failure      400  {object}  errors.AppError         "Invalid request parameters"
// @Security     Bearer
// @Security     ApiKeyAuth
...
// @Description  Get system-configured prompt template list
// @Tags         Tenant Management
// @Accept       json
// @Produce      json
