...
// @Description  Get all MinIO buckets and their access permissions
// @Tags         System
// @Accept       json
// @Produce      json
// @Success      200  {object}  ListMinioBucketsResponse  "Bucket list"
// @Failure      400  {object}  map[string]interface{}    "MinIO not enabled"
