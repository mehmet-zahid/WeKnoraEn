...
// @Failure      404  {object}  errors.AppError         "Chunk not found"
// @Security     Bearer
// @Security     ApiKeyAuth
...
// @Summary      Get Knowledge Chunks List
// @Description  Get all chunks list under specified knowledge with pagination support
// @Tags         Chunk Management
// @Accept       json
// @Produce      json
...
// @Description  Update specified chunk content and properties
// @Tags         Chunk Management
// @Accept       json
// @Produce      json
// @Param        knowledge_id  path      string              true  "Knowledge ID"
...
// @Description  Delete specified chunk
// @Tags         Chunk Management
// @Accept       json
// @Produce      json
// @Param        knowledge_id  path      string  true  "Knowledge ID"
...
// @Description  Delete all chunks under specified knowledge
// @Tags         Chunk Management
// @Accept       json
// @Produce      json
// @Param        knowledge_id  path      string  true  "Knowledge ID"
...
// @Description  Delete generated question in chunk
// @Tags         Chunk Management
// @Accept       json
// @Produce      json
// @Param        id       path      string                       true  "Chunk ID"
