...
func (h *AuthHandler) Register(c *gin.Context) {
	...
	// Disable registration via environment variable DISABLE_REGISTRATION=true
...
// @Description  Get detailed information of currently logged in user
// @Tags         Authentication
// @Accept       json
// @Produce      json
...
// @Description  Change current user's login password
// @Tags         Authentication
// @Accept       json
// @Produce      json
// @Param        request  body      object{old_password=string,new_password=string}  true  "Password change request"
// @Success      200      {object}  map[string]interface{}                           "Change successful"
// @Failure      400      {object}  errors.AppError                                  "Invalid request parameters"
// @Security     Bearer
