...
// @Failure      409               {object}  map[string]interface{}  "File duplicate"
// @Security     Bearer
// @Security     ApiKeyAuth
...
// @Failure      400      {object}  errors.AppError         "Invalid request parameters"
// @Failure      409      {object}  map[string]interface{}  "URL duplicate"
// @Security     Bearer
// @Security     ApiKeyAuth
...
// @Description  Manually input knowledge content in Markdown format
// @Tags         Knowledge Management
// @Accept       json
// @Produce      json
// @Param        id       path      string                       true  "Knowledge Base ID"
...
// @Description  Get knowledge list under knowledge base with pagination and filtering support
// @Tags         Knowledge Management
// @Accept       json
// @Produce      json
// @Param        id         path      string  true   "Knowledge Base ID"
