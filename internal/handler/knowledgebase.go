...
// @Description  Get all knowledge bases for current tenant
// @Tags         Knowledge Base
// @Accept       json
// @Produce      json
...
// @Description  Delete specified knowledge base and all its content
// @Tags         Knowledge Base
// @Accept       json
// @Produce      json
// @Param        id   path      string  true  "Knowledge Base ID"
...
// @Description  Get progress of knowledge base copy task
// @Tags         Knowledge Base
// @Accept       json
// @Produce      json
